...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('xacro',
            default_value = [os.path.join(get_package_share_directory('crs_support'), 'urdf', 'crs.urdf.xacro')]),
        launch.actions.DeclareLaunchArgument('srdf',
            default_value = [os.path.join(get_package_share_directory('crs_support'), 'urdf', 'ur10e_robot.srdf')]),
